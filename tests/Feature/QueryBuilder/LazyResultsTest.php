...
class LazyResultsTest extends TestCase
{
    ...
    public function test_lazy_results(): void
    {
    ...
    public function test_lazy_no_action_results(): void
    {
        $this->test_insert_table_products();
    ...
    public function test_lazy_again_results(): void
    {
        $this->test_insert_table_products();
    ...
    public function test_lazy_take_results(): void
    {
        $this->test_insert_table_products();
