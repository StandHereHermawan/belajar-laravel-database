...
class AggregateTest extends TestCase
{
    ...
    public function test_aggregate(): void
    {
        ...
        self::assertNotNull($collection);
        self::assertEquals(100, $collection);

        $collection = DB::table("products")->max("price");
        self::assertNotNull($collection);
        self::assertEquals(15000000, $collection);

        $collection = DB::table("products")->min("price");
        self::assertNotNull($collection);
        self::assertEquals(39500, $collection);

        $collection = DB::table("products")->avg("price");
        self::assertNotNull($collection);
        self::assertEquals(362020, $collection);

        $collection = DB::table("products")->sum("price");
        self::assertNotNull($collection);
        self::assertEquals(36202000, $collection);
    }
}
