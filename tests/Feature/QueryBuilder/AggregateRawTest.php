...
class AggregateRawTest extends TestCase
{
    ...
    public function test_aggregate_raw(): void
    {
        ...
        self::assertNotNull($collection);
        self::assertEquals(100, $collection[0]->total_product);
        self::assertEquals(39500, $collection[0]->min_price);
        self::assertEquals(15000000, $collection[0]->max_price);
    }
}
